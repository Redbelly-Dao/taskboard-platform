...
const RESOURCE_LINKS = [
  ...
  },
  {
    ...
    href: "https://discord.gg/YMpArA2Y8j",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        {/* Full Discord mark. The eyes are the two trailing subpaths and they punch through as holes on the
            default nonzero fill rule. An earlier copy of this path had only the outer shell, so the face was blank. */}
