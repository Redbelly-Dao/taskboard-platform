        ...
        {selected ? (
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {/* Rubric or admin override panel */}
              <div className="lg:col-span-2">
                {isOverrideMode ? (
                  ...
                  /* Full rubric (reviewer and admin for under_review submissions) */
                  <div className="card p-6">
                  ...
                  return (
                    <div key={sub.id} className="card p-5 hover:border-[#E63329] transition-colors">
                      ...
                      <div className="text-xs text-[#555555] space-y-1 mb-4">
                        ...
                        {isAdmin && sub.adminOverride && (
                          <p className="text-yellow-600 font-semibold">Admin override applied</p>
                        )}
                      </div>
